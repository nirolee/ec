...
function showtime()
{
  ...
  if (dateLeft > 0)
  {
    Temp = "<b>"+dateLeft+"</b>" + _day + "<b>"+hourZero+"</b>" + "<b>"+hourLeft+"</b>" + _hour + "<b>"+minuteZero+"</b>" + "<b>"+minuteLeft+"</b>" + _minute + "<b>"+secondZero+"</b>" + "<b>"+secondLeft+"</b>" + _second;
  }
  else
  {
    if (hourLeft > 0)
    {
      Temp = "<b>"+hourLeft+"</b>" + _hour + "<b>"+minuteZero+"</b>" + "<b>"+minuteLeft+"</b>" + _minute + "<b>"+secondZero+"</b>" + "<b>"+secondLeft+"</b>" + _second;
    }
    else
    {
      if (minuteLeft > 0)
      {
        Temp = "<b>"+minuteLeft+"</b>" + _minute + "<b>"+secondZero+"</b>" + "<b>"+secondLeft+"</b>" + _second;
      }
      else
      {
        if (secondLeft > 0)
