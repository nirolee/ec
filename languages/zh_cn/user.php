...
//@author guan start
$_LANG['label_single_sun'] = '商品评价/晒单';
...
$_LANG['passport_js']['username_shorter'] = '用户名长至少3个字。';
$_LANG['passport_js']['username_invalid'] = '格式不对，重新输入。';
$_LANG['passport_js']['password_empty'] = '登录密码不能为空。';
$_LANG['passport_js']['password_shorter'] = '密码至少6个字符。';
...
$_LANG['affiliate_intro'][0] = '<li>１、将本站提供给您的推荐代码，发送到论坛、博客上。</li><li>２、访问者点击链接，访问网店。</li><li>３、在访问者点击链接的 <b>%d%s</b> 内，若该访问者在本站注册，即认定该用户是您推荐的，您将获得等级积分 <b>%d</b> 的奖励 (当您的等级积分超过 <b>%d</b> 时，不再获得奖励)。</li><li>４、该用户今后在本站的一切消费，您均能获得一定比例的提成。目前实行的提成总额为订单金额的 <b>%s</b> 、积分的 <b>%s</b> ，分配给您、推荐您的人等，具体分配规则请参阅 <b><a href="#myrecommend">我推荐的会员</a></b>。</li><li>５、提成由管理员人工审核发放，请您耐心等待。</li><li>６、您可以通过分成明细来查看您的介绍、分成情况。</li>';
