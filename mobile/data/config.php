...
//网站全局配置
$config['site_name'] = '碧桂园创喜邦盛家居'; //站点名称
...
//EcTouch版本
$config['ver'] = '0.1'; //版本号
$config['ver_name'] = ' 0.1 测试版'; //版本名称
$config['ver_date'] = '201101281800'; //版本时间
$config['ver_author'] = '';
$config['ver_email'] = '';
$config['ver_url'] = 'http://www.jiajuz.com/';