...
?> 
        <li><a href="javascript:showPic()"><img alt="" src="<?php if ($this->_var['picture']['img_url']): ?><?php echo $this->_var['picture']['img_url']; ?><?php else: ?><?php echo $this->_var['site_url']; ?><?php echo $this->_var['picture']['thumb_url']; ?><?php endif; ?>" style="width:512px"/></a></li>
...
?> 
        <?php if (($this->_foreach['related_goods']['iteration'] - 1) % 2 == 1): ?>  <?php endif; ?> <li class="flex_in  "   <?php if (($this->_foreach['related_goods']['iteration'] - 1) % 2 == 1): ?> style="float:right" <?php endif; ?> > <a href="<?php echo $this->_var['releated_goods_data']['url']; ?>">
