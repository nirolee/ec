		...
		<table width="100%" border="0" cellspacing="0" cellpadding="5">
			...
			<tr>
				...
				<table width="100%" border="0" cellpadding="0" cellspacing="5"
					bgcolor="#EFEFEF">
					<tr align="center">
						<td><font size="3">Copyright (C) 2011 <a href=mailto:874889289@qq.com><font size="5"
							color="red"><b>longwuxu</b></font></a> All Rights Reserved .</font></td>
					</tr>
					<tr>
					<td align="right"><a href="http://localhost/FileContral/FileContral.php"><font color="blue">返回首页</font></a></td>
					</tr>
				</table>
				</td>
			</tr>
