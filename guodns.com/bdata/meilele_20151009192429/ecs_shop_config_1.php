...
E_D("replace into `ecs_shop_config` values('101','1','shop_name','text','','','国度网络','1');");
E_D("replace into `ecs_shop_config` values('102','1','shop_title','text','','','国度网络—中国企业网站建设第一平台!','1');");
E_D("replace into `ecs_shop_config` values('103','1','shop_desc','text','','','国度科技旗下国度网络致力于打造建站行业开拓者。国度为您提供域名空间、企业、商城、论坛、手机、微信等网站建设。同时还支持PC+手机+微信，三站合一，数据同步！','1');");
E_D("replace into `ecs_shop_config` values('104','1','shop_keywords','text','','','国度网络,国度模板,网站模板,企业网站模板,企业源码,国度网络,国度科技,网站建设,网页设计,网站制作,网站开发,智能建站系统,自助建站,手机网站,微信网站,三网合一,三站合一,数据同步,域名注册,空间租用,企业邮箱,400电话,国度快车,国度云站,国度系统,PC+手机+微站','1');");
E_D("replace into `ecs_shop_config` values('105','1','shop_country','manual','','','1','1');");
E_D("replace into `ecs_shop_config` values('106','1','shop_province','manual','','','6','1');");
E_D("replace into `ecs_shop_config` values('107','1','shop_city','manual','','','76','1');");
E_D("replace into `ecs_shop_config` values('108','1','shop_address','text','','','广州国度网络科技有限公司','1');");
E_D("replace into `ecs_shop_config` values('109','1','qq','text','','','11654547','1');");
E_D("replace into `ecs_shop_config` values('110','1','ww','text','','','xxxqq303228495','1');");
...
E_D("replace into `ecs_shop_config` values('115','1','service_phone','text','','','400-888-8888','1');");
...
E_D("replace into `ecs_shop_config` values('202','2','icp_number','text','','','京ICP备14008888号','1');");
...
E_D("replace into `ecs_shop_config` values('208','2','market_price_rate','text','','','1.3','1');");
...
E_D("replace into `ecs_shop_config` values('220','2','register_points','text','','','1000','1');");
...
E_D("replace into `ecs_shop_config` values('304','3','thumb_width','text','','','320','1');");
E_D("replace into `ecs_shop_config` values('305','3','thumb_height','text','','','200','1');");
E_D("replace into `ecs_shop_config` values('306','3','image_width','text','','','1024','1');");
E_D("replace into `ecs_shop_config` values('307','3','image_height','text','','','768','1');");
...
E_D("replace into `ecs_shop_config` values('315','3','bought_goods','text','','','8','1');");
...
E_D("replace into `ecs_shop_config` values('324','3','goods_gallery_number','text','','','10','1');");
...
E_D("replace into `ecs_shop_config` values('330','3','search_keywords','text','','','床,沙发,灯饰,转角沙发,实木床,全友家私,团购','0');");
...
E_D("replace into `ecs_shop_config` values('503','5','smtp_user','text','','','34828960@qq.com','1');");
E_D("replace into `ecs_shop_config` values('504','5','smtp_pass','password','','','yuaiying521','1');");
E_D("replace into `ecs_shop_config` values('505','5','smtp_mail','text','','','34828960@qq.com','1');");
...
E_D("replace into `ecs_shop_config` values('904','8','sms_ecmoban_user','text','','','admin','0');");
E_D("replace into `ecs_shop_config` values('905','8','sms_ecmoban_password','password','','','123456','0');");
