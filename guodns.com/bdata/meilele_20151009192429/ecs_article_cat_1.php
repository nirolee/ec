...
E_D("replace into `ecs_article_cat` values('13','美乐乐快讯','1','','','50','0','0');");
E_D("replace into `ecs_article_cat` values('14','创意家居','1','','','50','0','0');");
E_D("replace into `ecs_article_cat` values('15','咨询','1','','','50','0','0');");
E_D("replace into `ecs_article_cat` values('16','热帖','1','','','50','0','0');");
